                    ...
                    <div class="computers-container">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<a href='computer-details.php?computer_id=" . $row["id"] . "&lab_id=" . $labId . "'>";
                                ...
                                echo "<form method='POST' action='delete-computer.php'>";
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="formcomp" action="computers.php?lab_id=<?php echo $labId; ?>" method="post" enctype="multipart/form-data">
